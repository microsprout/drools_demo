...
public class PointRuleEngineImpl implements PointRuleEngine {
	...
	private List<String> getTestDrlFile() {
		...
		drlFilePath
				.add("/Users/bigbean/opt/mtsource/drools_demo/src/main/resources/demo_1/addpoint.drl");
		drlFilePath
				.add("/Users/bigbean/opt/mtsource/drools_demo/src/main/resources/demo_1/subpoint.drl");
